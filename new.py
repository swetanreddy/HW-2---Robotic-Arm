...
# letters_map = {
#     "A": [(0.5, 0.5), (1.03, 1.86), (1.46, 2.98), (1.84, 3.95), (2.25, 5), (2.65, 6.03), (3.03, 7.0), (3.41, 7.99), (4, 9.5), (4.59, 7.99), (4.97, 7.0), (5.35, 6.02), (5.75, 5), (6.17, 3.91), (6.53, 3.01), (6.98, 1.84), (7.5, 0.5), (5.75, 5), (5, 5), (4, 5), (3, 5), (2.25, 5)],
...
# 
# motor2_ms1 = Pin(36, Pin.OUT)
# motor2_ms2 = Pin(39, Pin.OUT)
# 
# motor1_ms1.init(Pin.OUT)
# motor1_ms2.init(Pin.OUT)
# 
# motor2_ms1.init(Pin.OUT)
# motor2_ms2.init(Pin.OUT)
# 
# motor1_ms1.value(1)
# motor1_ms2.value(1)
# motor2_ms1.value(1)
...
for i, initial in enumerate(input_initials):
    ...
    for i, angle in enumerate(angles):
        if i == 0:
            ...
            direction1 = 0 if new_theta1 > new_angles[i-1][0] else 1
            direction2 = 1 if new_theta2 > new_angles[i-1][1] else 0
